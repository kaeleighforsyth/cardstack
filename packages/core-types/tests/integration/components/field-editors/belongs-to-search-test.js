...
module('Integration | Component | field editors/belongs-to search editor', async function(hooks) {
  setupRenderingTest(hooks);

  test('can search', async function(assert) {
    this.set('model', modelStub);
    await render(hbs`{{field-editors/belongs-to-search-editor content=model field="feeling"}}`);
  ...
  test('can specify a different field to use for option', async function(assert) {
    ...
    await render(hbs`{{field-editors/belongs-to-search-editor content=model field="vehicle" editorOptions=editorOptions}}`);
  ...
  test('it can be disabled', async function(assert) {
    this.set('model', {});
    await render(hbs`{{field-editors/belongs-to-search-editor content=model field="feeling" disabled=true}}`);
